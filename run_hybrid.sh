...
home_dir="/user1/student/mtc/mtc2024/cs2436"
design_dir="$home_dir/designs/multi"
output_dir="$home_dir/poem/alg_hybrid"
...
while IFS= read -r line || [[ -n "$line" ]]; do
    ...
    {
        #~/poem/abc/abc -c "read $filename;fold; bmc3 -a -g -T 3600" 
        /user1/student/mtc/mtc2024/cs2436/poem/abc/abc -c "read $filename;fold; poem hybrid -L $output_dir/log.csv -v -T 3600 -M 512"
